...
Requires: alterator-module-executor >= 0.1.26
...
%changelog
* Thu Feb 26 2026 Maria Alexeeva <alxvmr@altlinux.org> 0.1.15-alt0.p11.3
- fix: search tests by actual displayed name (thx Andrey Alexeev)
  (closes: #53682)
