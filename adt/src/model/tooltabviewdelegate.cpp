    ...
    if (index.column() == 2)
    {
        ...
        if (index.column() == 2) //value
        {
            ...
            case ADTVarInterface::ADTVarType::INT: {
                ...
                connect(spinBox, &QSpinBox::valueChanged, this, &ToolTabViewDelegate::commit);
            ...
            case ADTVarInterface::ADTVarType::STRING: {
                ...
                connect(lineEdit, &QLineEdit::textEdited, this, &ToolTabViewDelegate::commit);
            ...
            case ADTVarInterface::ADTVarType::ENUM_INT: {
                ...
                connect(comboBox, &QComboBox::activated, this, &ToolTabViewDelegate::commit);
...
public:
    inline explicit CommitLock(bool &flag)
        : m_flag{flag}
    {
        m_flag = false;
    }

    inline ~CommitLock() { m_flag = true; }
};

void ToolTabViewDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const
{
    auto lock = CommitLock{may_commit};
...
void ToolTabViewDelegate::setWidget(ToolWidget *widget)
{
    m_widget = widget;
}
