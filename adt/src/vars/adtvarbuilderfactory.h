...
template<>
class ADTVarBuilderFactory<ADTVarBuilderInterface::BuilderType::MODE> final
{
public:
    static std::unique_ptr<ADTVarBuilderInterface> create() { return std::make_unique<ADTVarBuilderMode>(); }
};
